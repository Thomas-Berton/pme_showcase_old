    ...
    return (
        ...
        >
            <svg
                ...
                data-type="info"
                ref={props.svg}
                className="block m-auto relative svg_ballon	focus:outline-none ballonTrigger"
                style={{ left: " 130" }}
            ...
            >
                <defs>
                    <linearGradient id="gradient">
                        ...
                        />
                        <stop
                            style={{ stopColor: "#b8b8b8", stopOpacity: 0 }}
                            offset={1}
                        />
                    </linearGradient>
                    <linearGradient
                ...
                <g
                    ...
                    ref={props.balloon}
                    style={{
                        transform: "translate(0px, -4.8108px) scale(1) rotate(0deg)",
                    }}
                >
                    <g
                        className="balloon__tail"
                        ref={props.balloon__tail}
                    ...
                    >
                        ...
                        />
                        <path
                            className="balloon__broken_piece1"
                            ref={props.balloon__broken_piece1}
                            style={{
                                transform: "translate(0px, 0px) scale(1) rotate(-2.83187deg)",
                                transformOrigin: "174.808px 350.804px",
                            }}
                            fill="#efca15"
                    ...
                    <g
                        className="balloon__broken_pieces"
                        ref={props.balloon__broken_pieces}
                        style={{
                            transform: "translate(0px, 0px) scale(1) rotate(-2.83187deg)",
                            transformOrigin: "169.512px 349.92px",
                        }}
                    >
                        <path
                            className="balloon__broken_piece2"
                            ref={props.balloon__broken_piece2}
                            style={{
                                transform: "translate(0px, 0px) scale(1)",
                                transformOrigin: "265.795px 286.211px",
                            }}
                            fill="#efca15"
                        ...
                        />
                        <path
                            className="balloon__broken_piece3"
                            ref={props.balloon__broken_piece3}
                            style={{
                                transform: "translate(0px, 0px) scale(1)",
                                transformOrigin: "282.68px 174.269px",
                            }}
                            fill="#efca15"
                        ...
                        />
                        <path
                            className="balloon__broken_piece4"
                            ref={props.balloon__broken_piece4}
                            style={{
                                transform: "translate(0px, 0px) scale(1)",
                                transformOrigin: "223.775px 95.5413px",
                            }}
                            fill="#efca15"
                        ...
                        />
                        <path
                            className="balloon__broken_piece5"
                            ref={props.balloon__broken_piece5}
                            style={{
                                transform: "translate(0px, 0px) scale(1)",
                                transformOrigin: "100.766px 123.985px",
                            }}
                            fill="#efca15"
                        ...
                        />
                        <path
                            className="balloon__broken_piece6"
                            ref={props.balloon__broken_piece6}
                            style={{
                                transform: "translate(0px, 0px) scale(1)",
                                transformOrigin: "60.2183px 211.89px",
                            }}
                            fill="#efca15"
                        ...
                        />
                        <path
                            className="balloon__broken_piece7"
                            ref={props.balloon__broken_piece7}
                            style={{
                                transform: "translate(0px, 0px) scale(1)",
                                transformOrigin: "83.3102px 286.532px",
                            }}
                            fill="#efca15"
                    ...
                    <g
                        className="balloon__head_group"
                        ref={props.balloon__head_group}
                        style={{
                            transform: "translate(0px, 0px) scale(1) rotate(-2.83187deg)",
                            transformOrigin: "175px 350.776px",
                        }}
                    >
                        <g
                            className="balloon__effect"
                            ref={props.balloon__effect}
                            style={{
                                transform: "scale(1)",
                                transformOrigin: "175.96px 226.759px",
                            }}
                        >
                            <path
                                fill="url(#gradient1)"
